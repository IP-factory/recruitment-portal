...
import { useAdminAssessments, useAdminRole } from "@/hooks/useRecruitmentData";
...
import { describeLinkedAssessment, findLinkedAssessment } from "@/lib/roleConfigurationDisplay";
...
export default function AdminRoleForm({ roleSlug }: { roleSlug?: string }) {
  ...
  const linkedAssessment = roleSlug && existingRole.data && assessments.status === "ready" && assessments.data
    ? findLinkedAssessment(assessments.data.assessments, existingRole.data.slug)
    : null;
