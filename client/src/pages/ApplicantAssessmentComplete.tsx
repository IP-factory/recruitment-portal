/**
 * Task 24D-1 — assessment completion state.
 *
 * A calm success state that confirms the assessment is complete and directs
 * the applicant to the review step.
 */
  ...
  return (
    <ApplicationShell activeStep={2}>
      <section className="mx-auto max-w-[620px] py-10 text-center sm:py-14">
        ...
        <p className="mt-4 text-[15px] leading-7 text-muted-foreground">You have completed the assessment. You can now continue to review your application before submission.</p>
        ...
        <div className="mt-8 flex flex-col gap-3 sm:flex-row sm:justify-center">
          <FoundationButton onClick={() => setLocation(`/apply/${roleSlug}/review`)} size="lg">Continue to review</FoundationButton>
          <FoundationButton onClick={() => setLocation(`/apply/${roleSlug}/assessment/questions`)} variant="secondary">Review assessment responses</FoundationButton>
        </div>
      </section>
    </ApplicationShell>
  );
