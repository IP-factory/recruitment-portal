...
export type AdminStatus = "Submitted" | "In Progress" | "Under Review" | "Shortlisted" | "Interview" | "Rejected" | "Hired" | "Closed — Eligibility";
